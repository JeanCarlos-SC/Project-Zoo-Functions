...
## 🌍 Sobre o Projeto:
O projeto Zoo Functions foi o projeto que finalizou o primeiro módulo do curso da Trybe, o módulo de 'Fundamentos do Desenvolvimento Web', o foco principal do projeto foi a utilização de Higher Order Functions, ou simplesmente Hofs. O desenvolvimento do projeto consistiu em manipular um imenso objeto com dados de um zoológico fictício, dados de animais, horários e funcionários, tudo isso dentro de um objeto, com vários outros objetos e arrays dentro dele, contendo as informações necessárias(o objeto completo esta dentro da pasta data). O projeto apresentou diversos problemas para resolver, cada um desses problemas envolviam manipular o objeto data, utilizando as Hofs para conseguir a solução do mesmo. No desenvolvimento do projeto também foi utilizado o método de TDD(Test-Driven Development) e as novas funcionalidades do JavaScript introduzidas no ES6.

<img src='img/pf.png' alt='porcentagem de requisitos'></img>
